<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="字典标签(EN)" align="center" prop="dictLabelEn" />
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="数据标签(EN)" prop="dictLabelEn">
          <el-input v-model="form.dictLabelEn" placeholder="请输入数据标签(EN)" />
        </el-form-item>
